function start5x5Game(difficulty) {
    const canvas = document.getElementById('canvas5x5'); // Seleccionar el canvas específico
    const canvasSize = 500; // Tamaño del canvas más grande
    ...
    function drawTitleAndDescription() {
        ...
        ctx.fillText("5x5 Cuadro Mágico", canvas.width / 2, 30);

        ctx.font = "12px Arial";
        ctx.fillText(
            "Llena el cuadro mágico con números del 1 al 25 siguiendo el orden correcto.",
            canvas.width / 2,
            60
        );
        ctx.fillText(
